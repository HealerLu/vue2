  ...
  export default {
    ...
    methods: {
      ...
      calendarSelectAll(start) {
        this.$axios({
          method: "post",
          url: 'http://192.16.10.112:50000/calendarSelectAll?size=5&np=' + start,
          data: {
            //           np1:1,
            //   size1:5
          }//向后端传递参数
      ...
      calendarDelete(id) {
        this.$axios({
          method: "post",
          url: 'http://192.16.10.112:50000/calendarDelete?id=' + id,
          data: {
            //           np1:1,
            //   size1:5
          }//向后端传递参数
        ...
        // axios.delete('http://192.16.10.112:50000/calendarDelete?id='+id).then(function(response){
      ...
      calendarInsertUpdate() {
        ...
        if (this.tblcal.id > 0) {
          //update
          url = 'http://192.16.10.112:50000/calendarUpdate?id=' + this.tblcal.id;
        } else {
          //insert
          url = 'http://192.16.10.112:50000/calendarInsert';
        }
        //axios提交
        this.$axios({
          method: "post",
